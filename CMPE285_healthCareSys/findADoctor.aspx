<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="findADoctor.aspx.cs" Inherits="CMPE285_healthCareSys.findADoctor" %>
...
<head runat="server">
    ...
    <title>Find a Doctor Page</title>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="findADoctor.aspx">Find a Doctor</a></li>
